...
if __name__ == "__main__":
    # This runs without anything above!!! :) We'd also be able to render it with the direct call to the class I think
    render_interactively("sampling.py", control_two_agents=True)